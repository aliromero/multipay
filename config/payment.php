...
return [
    ...
    */
    ...
    | Romero\Multipay\Abstracts\Driver in your driver.
    |
    */
    'map' => [
        'local' => \Romero\Multipay\Drivers\Local\Local::class,
        'fanavacard' => \Romero\Multipay\Drivers\Fanavacard\Fanavacard::class,
        'asanpardakht' => \Romero\Multipay\Drivers\Asanpardakht\Asanpardakht::class,
        'atipay' => \Romero\Multipay\Drivers\Atipay\Atipay::class,
        'behpardakht' => \Romero\Multipay\Drivers\Behpardakht\Behpardakht::class,
        'digipay' => \Romero\Multipay\Drivers\Digipay\Digipay::class,
        'etebarino' => \Romero\Multipay\Drivers\Etebarino\Etebarino::class,
        'idpay' => \Romero\Multipay\Drivers\Idpay\Idpay::class,
        'irankish' => \Romero\Multipay\Drivers\Irankish\Irankish::class,
        'jibit' => \Romero\Multipay\Drivers\Jibit\Jibit::class,
        'nextpay' => \Romero\Multipay\Drivers\Nextpay\Nextpay::class,
        'omidpay' => \Romero\Multipay\Drivers\Omidpay\Omidpay::class,
        'parsian' => \Romero\Multipay\Drivers\Parsian\Parsian::class,
        'pasargad' => \Romero\Multipay\Drivers\Pasargad\Pasargad::class,
        'payir' => \Romero\Multipay\Drivers\Payir\Payir::class,
        'paypal' => \Romero\Multipay\Drivers\Paypal\Paypal::class,
        'payping' => \Romero\Multipay\Drivers\Payping\Payping::class,
        'paystar' => \Romero\Multipay\Drivers\Paystar\Paystar::class,
        'poolam' => \Romero\Multipay\Drivers\Poolam\Poolam::class,
        'sadad' => \Romero\Multipay\Drivers\Sadad\Sadad::class,
        'saman' => \Romero\Multipay\Drivers\Saman\Saman::class,
        'sep' => \Romero\Multipay\Drivers\SEP\SEP::class,
        'sepehr' => \Romero\Multipay\Drivers\Sepehr\Sepehr::class,
        'walleta' => \Romero\Multipay\Drivers\Walleta\Walleta::class,
        'yekpay' => \Romero\Multipay\Drivers\Yekpay\Yekpay::class,
        'zarinpal' => \Romero\Multipay\Drivers\Zarinpal\Zarinpal::class,
        'zibal' => \Romero\Multipay\Drivers\Zibal\Zibal::class,
        'novinpal' => \Romero\Multipay\Drivers\Zibal\Novinpal::class,
        'sepordeh' => \Romero\Multipay\Drivers\Sepordeh\Sepordeh::class,
        'rayanpay' => \Romero\Multipay\Drivers\Rayanpay\Rayanpay::class,
        'sizpay' => \Romero\Multipay\Drivers\Sizpay\Sizpay::class,
        'vandar' => \Romero\Multipay\Drivers\Vandar\Vandar::class,
        'aqayepardakht' => \Romero\Multipay\Drivers\Aqayepardakht\Aqayepardakht::class,
        'azki' => \Romero\Multipay\Drivers\Azki\Azki::class,
        'payfa' => \Romero\Multipay\Drivers\Payfa\Payfa::class,
        'toman' => \Romero\Multipay\Drivers\Toman\Toman::class,
        'bitpay' => \Romero\Multipay\Drivers\Bitpay\Bitpay::class,
    ]
];
